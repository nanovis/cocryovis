...
import { modelSchemaWithCheckpoint } from "./componentSchemas/model-schema";
import { projectAccessSchema } from "./componentSchemas/project-access-schema";
import { userAccessSchema } from "./componentSchemas/user-access-schema";
import { defaultError } from "./error-path-schema";
import { deepVolumeSchema } from "./volume-path-schema";
...
export const projectPath: ZodOpenApiPathsObject = {
  "/projects-deep": {
    get: {
      responses: {
        200: {
