...
def raw_to_h5(raw_file_path: str, output_path: str, dimensions: Dimensions, log=True):
    ...
    with h5py.File(output_path, 'w') as file:
        file.create_dataset("raw_data", data=np_data)
...
if __name__ == '__main__':
    ...
    raw_to_h5(args.raw, args.output, dims, args.log)
